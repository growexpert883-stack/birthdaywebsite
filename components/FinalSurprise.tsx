...
export default function FinalSurprise() {
  ...
  return (
    <section className="min-h-screen bg-black text-white flex items-center justify-center px-6 py-32 overflow-hidden">
      <div className="w-full max-w-3xl text-center">

        {!opened ? (
          <div className="animate-[fadeIn_1s_ease-out]">

            <p className="text-xs md:text-sm uppercase tracking-[0.4em] text-white/40 mb-6">
              One last thing...
            </p>
            ...
            <p className="max-w-xl mx-auto mt-6 text-base md:text-lg text-white/60 leading-relaxed">
            ...
            <button
              ...
              className="mt-12 px-9 py-4 rounded-full border border-white/30 text-white transition-all duration-300 hover:scale-105 hover:shadow-xl hover:border-white/60"
            >
          ...
          <div className="animate-[fadeIn_1.2s_ease-out]">
            ...
            <p className="text-xs uppercase tracking-[0.4em] text-white/40 mb-7">
              For Minal
            </p>
